...
export default function BootScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-6 sm:p-10 animate-in zoom-in-95 duration-500 glass shadow-2xl rounded-[1.8rem] sm:rounded-[2.5rem] border-primary/20 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-2 sm:mb-3 tracking-tighter">ExamOS <span className="text-text-main/50">V1</span></h1>
          <p className="text-text-dim text-base sm:text-lg font-bold mb-8 sm:mb-10 leading-tight">Adaptive Mastery Engine</p>
          ...
          <form onSubmit={handleBoot} className="w-full space-y-6">
             ...
             <Button type="submit" className="w-full h-14 sm:h-16 text-lg sm:text-xl font-black shadow-2xl shadow-primary/30 rounded-xl sm:rounded-[1.5rem]" disabled={username.trim().length === 0}>
                INITIALIZE BOOT
             </Button>
          </form>
